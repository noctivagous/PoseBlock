...
function toStoreInstance(ext: PoseBlockInstance): CharacterInstance {
  return {
    ...
    poseSourceMode: ext.poseSourceMode ?? 'preset',
    animationPoseModelId: ext.animationPoseModelId ?? '',
    animationClip: ext.animationClip ?? null,
    animationFrame: ext.animationFrame ?? 0,
    ...
    characterRotationZ: ext.characterRotationZ ?? 0,
...
function instancesSignature(instances: PoseBlockInstance[] | undefined): string {
  ...
  return JSON.stringify(
    instances.map((inst) => ({
      ...
      poseSourceMode: inst.poseSourceMode ?? 'preset',
      animationPoseModelId: inst.animationPoseModelId ?? '',
      animationClip: inst.animationClip ?? null,
      animationFrame: inst.animationFrame ?? 0,
      ...
      characterRotationZ: inst.characterRotationZ ?? 0,
